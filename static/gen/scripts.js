...
if (window.serious == null) {
  window.serious = {};
}

if (window.serious.Utils == null) {
...
window.serious.Widget = (function() {
  function Widget() {
    ...
    this._bindUI = __bind(this._bindUI, this);
  }
    ...
    if (!ui.length) {
      ...
      if (widget_class != null) {
        ...
        if (typeof ko !== "undefined" && ko !== null) {
          ko.applyBindings(widget.scope, ui.get(0));
        }
        return widget;
      } else {
  ...
  Widget.prototype._bindUI = function(ui) {
    var key, nui, value, _ref, _results;
    ...
    if (typeof this.UIS !== "undefined") {
      ...
      for (key in _ref) {
        ...
        _results.push(this.uis[key] = nui);
      }
      return _results;
    }
  };
  ...
  Widget.prototype._bindClick = function(nui, action) {
    if ((action != null) && __indexOf.call(this.ACTIONS, action) >= 0) {
      return nui.click((function(_this) {
        return function(e) {
          _this[action](e);
...
Navigation = (function(_super) {
  ...
  Navigation.prototype.bindUI = function() {
    return this.scope.features = ko.observableArray(this.feature);
  };
